...
class NiftySourceConfig(NamedTuple):
    """
...
class NiftyTargetConfig(NamedTuple):
    """
...
class Nifty_ETL():
    """
    Reads the Nifty data, transforms and writes the transformed data to target
    """

    def __init__(self, s3_bucket_src: S3BucketConnector,
                 s3_bucket_trg: S3BucketConnector, meta_key: str,
                 src_args: NiftySourceConfig, trg_args: NiftyTargetConfig):
        """
        Constructor for NiftyTransformer
